...
export class GastosPage {
  ...
  onCategoria(event: any) {
    this.filtroCategoria.set(event.detail.value);
  }
  onOrden(event: any) {
    this.filtroOrden.set(event.detail.value);
  }
  ...
  async abrirNuevoGasto() {
    ...
    // Verificar presupuesto después de agregar
    await this.notificationService.verificarPresupuesto();
  }
